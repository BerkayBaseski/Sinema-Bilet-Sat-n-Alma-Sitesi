...
<body style="height: 100vh;">
    ...
    <div class="tanitim-kapsayici">
        <div class="tanitim-alt">
            <img src="resimler/johnwick.jpg">
            <a target="_blank" class="oynat" href="https://www.youtube.com/watch?v=p7VF78wSfS8"><i class="bi bi-play-circle oynat"></i></a>
            <div class="tanitim-text">
                <h1>John Wick 4</h1>
                <br>
                <p>22 Mart 2023 Sinemada / 2s 50dk / Aksiyon</p>
                <p>Yönetmen: <a target="_blank" href="https://tr.wikipedia.org/wiki/Chad_Stahelski">Chad Stahelski</a></p>
                <p>Senarist: <a target="_blank" href="https://www.beyazperde.com/sanatcilar/sanatci-410918/">Michael Finch,</a> <a target="_blank" href="https://www.beyazperde.com/sanatcilar/sanatci-816145/">Shay Hatten</a></p>
                <p>Oyuncular: <a href="">Keanu Reeves,</a> <a href="">Bill Skarsgård</a></p>
                <p>Orijinal adı: <a href=""> John Wick: Chapter 4</a></p>
            </div>
            <div class="tanitim-buton">
                <button style="width: 120px; cursor: pointer;"><a href="https://www.youtube.com/watch?v=p7VF78wSfS8" target="_blank">FRAGMANI İZLE</a></button>
                <button style="width: 100px; cursor: pointer;"><a href="johnwick1.php">BİLET AL</a></button>
